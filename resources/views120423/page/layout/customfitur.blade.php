<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#kategori").change(function() {
      document.location.href = "{{url('postingan/keyword')}}" + "/" + x.value + "-" + y.value;
    })
  })
  $(document).ready(function() {
    $(".more").click(function() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.kosong) {
            toastr.warning("Lengkapi Form", "Berikan Detail Laporan!", {
              timeOut: 4e3,
              closeButton: !0,
              debug: !1,
              newestOnTop: !0,
...
<script>
  (function($) {
    ...
    new quixSettings({
      ...
      navheaderBg: "color_8", //have 10 options, "color_1" to "color_10"
