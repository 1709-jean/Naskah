            ...
            <form enctype="multipart/form-data" action="{{route('daftar_akun')}}" method="post">
              ...
              <div class="row px-3">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="number" name="nik" class="mb-4" required="" value="{{ old('nik') }}" autofocus="" autocomplete="off" placeholder="NIK">
                </div>
                <div class="col-lg-6">
                  <label class="mb-1">
                    <h6 class="mb-0 text-sm">Nama</h6>
                  </label>
                  <input type="text" name="name" class="mb-4" required="" value="{{ old('name') }}" autofocus="" autocomplete="off" placeholder="Nama Lengkap">
                </div>
                <div class="col-lg-6">
                  <label class="mb-1">
                    <h6 class="mb-0 text-sm">Email</h6>
                  </label>
                  <input type="email" name="email" class="mb-4" required="" value="{{ old('email') }}" autofocus="" autocomplete="off" placeholder="Email Aktif">
                </div>
                <div class="col-lg-6">
                  <label class="mb-1">
                    <h6 class="mb-0 text-sm">Telepon</h6>
                  </label>
                  <input type="number" name="telepon" minlength="10" class="mb-4" value="{{ old('telepon') }}" required="" autofocus="" autocomplete="off" placeholder="Nomor Handphone">
                </div>
                <div class="col-lg-12">
                  <label class="mb-1">
                    <h6 class="mb-0 text-sm">Foto KTP</h6>
                  </label>
                  <input type="file" name="foto" autocomplete="off" required="" class="mb-4">
                </div>
                <div class="col-lg-12">
                  <label class="mb-1">
                    <h6 class="mb-0 text-sm">Password</h6>
                  </label>
                  <input type="password" id="password" name="password" autocomplete="off" required="" placeholder="Masukkan Password">
                </div>
...
<script type="text/javascript">
  sweetAlert({
    icon: 'warning',
    type: 'warning',
    title: 'Emaill/NIK/Telepon Telah Didaftarkan',
