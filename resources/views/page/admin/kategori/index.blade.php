          ...
          <table class="table table-borderd table-hover zero-configuration">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="center">
                  <a href="" data-toggle="modal" data-target="#edit{{$dt->id_kategori}}" class="btn btn-sm text-white btn-success">
                    <i class="fa fa-edit"></i></a>
                  <a href="#" onclick="return confirm('Lanjut Hapus Data {{$dt->nama_kategori}}?')" class="btn btn-sm btn-danger" title='Hapus Data'><i class="fa fa-trash"></i></a>
                </td>
              </tr>
